...
const Register = () => {
    const { createUser, signIn, setLoading, updateUserProfile, signInWithGoogle, loading } = AuthProvider();
            ...
            <div className="md:flex justify-center items-center gap-10 rounded-md border-2 shadow-md p-5">
                ...
                <div className="w-full max-w-md p-5 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 shadow-xl">
                    ...
                    <form noValidate="" action="" className="space-y-6">
                        ...
                        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600 uppercase btn bg-pink-500 hover:bg-pink-400">Register</button>
                    </form>
                    ...
                    <div className="flex justify-center space-x-4">
                        <button onClick={handleGoogleSignIn} disabled={loading} aria-label="Log in with Google" className="p-3 rounded-sm">
